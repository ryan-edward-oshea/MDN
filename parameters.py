...
parser.add_argument("--data_loc",  default="/home/ryanoshea/in_situ_database/Working_in_situ_dataset/Augmented_Gloria_V3_2/",    help="Location of in situ data") #Working_in_situ_dataset/in_situ_data" in_situ_brandon_Mike
...
update.add_argument("--product",   default="aph,chl,tss,cdom,pc,ag,ad",        help="Product to estimate") #aph,chl,tss,cdom,nap,pc,Scdom443,Snap443 #,tss,cdom,nap,pc,Scdom443,Snap443  # "chl,tss,cdom,nap,pc,Scdom443,Snap443,aph,secchi" #"chl,tss,cdom,nap,pc,Scdom443,Snap443,aph,secchi"#"chl,tss,cdom,pc,ag,aph,ad"
...
#Manipulate loading of data sources
...
flags.add_argument("--use_ratio",     action ="store_false", help="Add band ratios as input features")
