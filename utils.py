...
def download_weights(model_path_name):
    ...
    downloadable_weights = {
	 ...
	 '698e59d1c9f604a5956a303f6d472c6b8e6a064d10b3f5131b452666fd712b2d' : ["PACE-delivery",  MDN_folder + 'PACE-delivery/698e59d1c9f604a5956a303f6d472c6b8e6a064d10b3f5131b452666fd712b2d.zip',  "https://nasagov.box.com/shared/static/eevzbezbl5xj5p7irp3jk20g0gmtlgqb.zip"],
	 '3559908f0e198546e108084db62ba17b644bffe31d40adabfa9752cb43bcacbc' : ["PACE-delivery",  MDN_folder + 'PACE-delivery/3559908f0e198546e108084db62ba17b644bffe31d40adabfa9752cb43bcacbc.zip', "https://nasagov.box.com/shared/static/eevzbezbl5xj5p7irp3jk20g0gmtlgqb.zip"]
...
def generate_config(args, create=True, verbose=True):
	...
	if args.sensor in ['PRISMA','HICO','PACE', 'PACE-delivery'] and args.product=='aph,chl,tss,pc,ad,ag,cdom': dependents+= ['allow_missing','allow_nan_inp','allow_nan_out','filter_ad_ag','min_in_out_val','removed_dataset']
